...
| `npm run build:dev` | Builds a unminified copy of your gameInit, with source maps, for debugging purposes. |
| `npm run build:prod` | Builds a minified copy of your gameInit without source maps for production use. |
